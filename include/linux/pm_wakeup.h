...
extern void wakeup_source_prepare(struct wakeup_source *ws, const char *name);//added by weiqiang.zhou on 9783335
extern struct wakeup_source *wakeup_source_create(const char *name);
extern void wakeup_source_drop(struct wakeup_source *ws);//added by weiqiang.zhou on 9783335
