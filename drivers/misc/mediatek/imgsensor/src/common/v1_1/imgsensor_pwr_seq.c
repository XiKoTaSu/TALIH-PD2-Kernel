...
#if defined(TSPPK8A3288_GC08A3_MIPI_RAW)
	{
		SENSOR_DRVNAME_TSPPK8A3288_GC08A3_MIPI_RAW,
		{
			{RST, Vol_Low, 1},
...
#endif
#if defined(TSPPK8F3287_GC08A3_MIPI_RAW)
	{
		SENSOR_DRVNAME_TSPPK8F3287_GC08A3_MIPI_RAW,
		{
			{RST, Vol_Low, 1},
			{SensorMCLK, Vol_High, 1},
			{DOVDD, Vol_1800, 0},
...
#endif
#if defined(TSPPKCF3290_GC13A0_MIPI_RAW)
	{
		SENSOR_DRVNAME_TSPPKCF3290_GC13A0_MIPI_RAW,
		{
			{RST, Vol_Low, 1},
			{SensorMCLK, Vol_High, 1},
			{DOVDD, Vol_1800, 0},
