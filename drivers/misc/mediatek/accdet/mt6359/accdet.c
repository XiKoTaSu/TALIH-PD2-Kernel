...
//Begin added by lanying.he for ocp96011 on 2023/7/11
#ifdef CONFIG_TCT_MT6359_FSA4480
static atomic_t accdet_init_flag;
static u32 fsa4480_eint_state = EINT_PIN_PLUG_OUT;
...
#endif
//End added by lanying.he for ocp96011 on 2023/7/11
...
#endif
//Begin added by lanying.he for ocp96011 on 2023/7/11
#if defined (CONFIG_TCT_MT6359_FSA4480)
void accdet_eint_callback_wrapper(unsigned int plug_status)
{
	...
	if(atomic_read(&accdet_init_flag) == 0){
		...
		mod_timer(&accdet_fsa4480_timer, (jiffies + ACCDET_CALLBACK_WAIT_TIMER));
		return;
	}
...
static void delay_fsa4480_timerhandler(struct timer_list *t)
{
	...
	cur_eint_state = fsa4480_eint_state;
...
#endif
//Begin modify by lanying.he for ocp96011 on 2023/7/11
//#ifdef CONFIG_ACCDET_EINT
#if defined (CONFIG_ACCDET_EINT) || defined (CONFIG_TCT_MT6359_FSA4480)
//End added by lanying.he for ocp96011 on 2023/7/11
