...
#ifdef CONFIG_TCT_SMARTPA_AW883XX
#include "../../codecs/aw883xx_v1.3/aw883xx_ext.h"
#endif
...
//Begin added by lanying.he for aw883xx bringup
  	...
  	[MTK_SPK_AW883xx_LEFT] = {
  		.i2c_probe = aw883xx_i2c_probe,
  		.i2c_remove = aw883xx_i2c_remove,
  		.codec_dai_name = "aw883xx-aif-9-34",
  		.codec_name = "aw883xx_smartpa.9-0034",
  	},
	
  	[MTK_SPK_AW883xx_RIGHT] = {
  		.i2c_probe = aw883xx_i2c_probe,
  		.i2c_remove = aw883xx_i2c_remove,
  		.codec_dai_name = "aw883xx-aif-9-36",
  		.codec_name = "aw883xx_smartpa.9-0036",
  	},

#endif
 #if defined(CONFIG_TCT_SMARTPA_4PA)
  	[MTK_SPK_AW883xx_LEFT_1] = {
  		.i2c_probe = aw883xx_i2c_probe,
  		.i2c_remove = aw883xx_i2c_remove,
  		.codec_dai_name = "aw883xx-aif-9-35",
  		.codec_name = "aw883xx_smartpa.9-0035",
  	},
	
  	[MTK_SPK_AW883xx_RIGHT_1] = {
  		.i2c_probe = aw883xx_i2c_probe,
  		.i2c_remove = aw883xx_i2c_remove,
  		.codec_dai_name = "aw883xx-aif-9-37",
  		.codec_name = "aw883xx_smartpa.9-0037",
  	},
