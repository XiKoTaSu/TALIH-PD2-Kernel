...
//Begin added by lanying.he for aw883xx bringup						  
						  MTK_SPK_AWINIC_AW883XX_LEFT,

    					  MTK_SPK_AWINIC_AW883XX_RIGHT,
#if defined(CONFIG_TCT_SMARTPA_4PA)
						  MTK_SPK_AWINIC_AW883XX_LEFT_1,
						  MTK_SPK_AWINIC_AW883XX_RIGHT_1,
#endif					  
//End added by lanying.he for aw883xx bringup						  
...
//Begin modify by lanying.he for es7210 mclk
#if defined(CONFIG_TCT_ES7210)
	unsigned int mclk_fs_ratio = 256;
#else
	unsigned int mclk_fs_ratio = 128;
#endif	
//End modify by lanying.he for es7210 mclk
...
//Begin added by lanying.he for aw883xx bringup
#if defined(CONFIG_TCT_SMARTPA_AW883XX)
 struct snd_soc_dai_link_component awinic_codecs[] = {
 {
   	.of_node = NULL,
   	.dai_name = "aw883xx-aif-9-34",
   	.name = "aw883xx_smartpa.9-0034",
   	},

	{
   	.of_node = NULL,
  	.dai_name = "aw883xx-aif-9-36",
  	.name = "aw883xx_smartpa.9-0036",
  	},
#if defined(CONFIG_TCT_SMARTPA_4PA)
    {
   	.of_node = NULL,
   	.dai_name = "aw883xx-aif-9-35",
   	.name = "aw883xx_smartpa.9-0035",
   	},

	{
   	.of_node = NULL,
  	.dai_name = "aw883xx-aif-9-37",
  	.name = "aw883xx_smartpa.9-0037",
  	},
#endif	
...
static struct snd_soc_dai_link mt6885_mt6359_dai_links[] = {
	...
	},
	{
		.name = "I2S3",
		.cpu_dai_name = "I2S3",
//Begin modify by lanying.he for aw883xx bringup		
#if defined(CONFIG_TCT_SMARTPA_AW883XX)
...
//Begin added by lanying.he for es7210 bring up
#elif defined(CONFIG_TCT_ES7210)
		.codec_dai_name = "ES7210 4CH ADC 0",
		.codec_name = "es7210.7-0040",
#else
//End added by lanying.he for es7210 bring up
		.codec_dai_name = "snd-soc-dummy-dai",
		.codec_name = "snd-soc-dummy",
#endif
		.no_pcm = 1,
